const EngineeringCard = ({ activeMembers, showEngineering }) => {
  return (
    <div className="rounded-mini bg-white shadow-[0px_0px_10px_rgba(0,_0,_0,_0.15)] overflow-hidden flex flex-row items-center justify-start py-[13px] pr-[11px] pl-5 box-border gap-[43px] max-w-full text-left text-lg text-black font-inter mq450:flex-wrap mq450:gap-[43px]">
